...
```{r, echo = TRUE, fig.height = 10,fig.width = 15, warning = FALSE, message = FALSE}
ggparcoord(data = kids_drinks_clusters, 
           ...
           alphaLines = 0.2,
           boxplot = TRUE, 
           title = "Multiple Parallel Coordinates Plots of Kids Drinks 
           Types clusters at Starbucks by Nutrition Factors
