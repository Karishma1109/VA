---
title: "Visualizing Time Series stock price data top 40 Companies"
description: |
...
Subsequently, the *csv* file loaded into an R data frame "topcompanies" as shown in the code chunk below, using the "read_csv()" function from the "tidyverse" package. Then, using the *boolean masking* on the "topcompanies" data frame, "which()" function and condition that the "Rank"(ranks the companies based on their market capitalization) field from the data frame is less than 41, top 40 companies data was saved into another data frame "top40companies".
