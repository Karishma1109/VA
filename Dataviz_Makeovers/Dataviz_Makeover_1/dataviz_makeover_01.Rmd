...
Important aspects to consider while judging the context of a chart^2^:
  ...
  The chart aims to show the trends in LFPR across various age-groups in the Singapore over the time period 2010 to 2012.
...
![*Fig. 16a: Editing the y-axis*](images/image25.jpg){width=70%}
...
![*Fig. 17: Adding caption to the chart*](images/image27.jpg){width=70%}
...
![*Fig. 19: Adding Chart Title and sub-title*](images/image30.jpg){width=70%}
...
![*Fig. 20a: Addting annotations*](images/image28.jpg){width=70%}

![*Fig. 20b: Change the text and text style of annotations*](images/image31.jpg){width=70%}


![*Fig. 20c: Format the annotations*](images/image32.jpg){width=70%}

![*Fig. 20d: Format options choosen for annotations*](images/image33.jpg){width=70%}


The final visualization can be found my [tableau](https://public.tableau.com/app/profile/karishma.yadav2567/viz/LabourForceParticipationRatesLFPRofSingaporeResidentsbyAgeGroupsovertheyears2010to2021/Sheet1?publish=yes) account:
![*Fig. 21: Dataviz Makeover*](images/final_dv.png)

## 4.4 Major Observations from the data visualization:

   1. The age groups 24 to 54 have LFPR(%) over 70% indicating that this age-group represents the working population of Singapore. The lower age group 15-19 and higher age-group 70 & over have similar LFPR(%). The age-group 20 to 24 has LFPR(%) between 50% to 70% for the years 2010 to 2021 indicating that the residents in Singapore start working in their early 20s.
   
   2. The LFPR(%) changes for the age-groups 15 to 24 vary with increases and decreases in the LFPR(%) for the period 2010-2021. The age-group 24 to 29 saw a steady LFPR(%) between 2015 to 2021 while the age-groups 30 to 54 saw slight increases in LFPR(%). The older age-groups have seen comparatively steep rise in LFPR(%) for the years 2010-2021. 
