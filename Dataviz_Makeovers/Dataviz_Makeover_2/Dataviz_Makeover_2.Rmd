...
![*Figure 36: Bus-Trips across Planning sub-zones in Singapore by Day Type"*](images/image32.jpg){width=70%}
...
![*Figure 37: Adding Navigation Buttons to the Dashboards"*](images/image33.jpg){width=70%}


# 7. Observations:

1.	From the figure given below, it can be observed that the morning and evening peak of inbound and outbound bus trips respectively is also an indication of the workforce commuting to and from the airport.

![*Figure 38: Peak time for outgoing bus-trips"*](images/image38.jpg){width=70%}

![*Figure 39: Peak time for incoming bus-trips"*](images/image39.jpg){width=70%}


2.	Incase of Sentosa an interesting trend has been observed as shown in the figure given below, where the number of inbound trips on weekend around 11 am is same as on weekdays. This tells us that the place is a popular spot for recreation. 

![*Figure 40: Adding Navigation Buttons to the Dashboards"*](images/image34.jpg){width=70%}
...
![*Figure 41: Most popular Sub-Zone"*](images/image35.jpg){width=70%}

![*Figure 42: Most popular Sub-Zone"*](images/image37.jpg){width=70%}
